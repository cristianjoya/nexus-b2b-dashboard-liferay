...
interface AccountsTabProps {
	...
	/** Si se informa, limita el listado a cuentas de ese owner (B2B User). */
...
export function AccountsTab({
	...
	const listParams = useMemo(
		...
		[accountType, effectiveOwnerUserId, page, search, status],
	);
