		...
		>
			...
			>
				...
				<div className="nexus-modal-body nexus-form-stack">
					...
					<div className="nexus-form-field space-y-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3">
						<span className="nexus-label text-sm font-medium">
							Saldo (COP) — solo lectura
						</span>
						...
						<span className="nexus-text-muted text-xs">
							No se puede editar. Se calcula solo con movimientos
							completados y créditos aprobados.
						</span>
					</div>
