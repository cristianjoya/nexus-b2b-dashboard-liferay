...
public interface AccountResource {
	...
	public Page<Account> getAccountsPage(
			String search, String accountType, Integer status,
	...
	public Page<B2bAssignableUser> getAssignableB2BUsersPage() throws Exception;

	public HttpInvoker.HttpResponse getAssignableB2BUsersPageHttpResponse()
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/fin-services-rest/v1.0/accounts/{accountId}");
		...
		public HttpInvoker.HttpResponse deleteAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/fin-services-rest/v1.0/accounts/batch");
		...
		public Page<Account> getAccountsPage(
			...
			HttpInvoker.HttpResponse httpResponse = getAccountsPageHttpResponse(
				search, accountType, status, pagination);
		...
		public HttpInvoker.HttpResponse getAccountsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/fin-services-rest/v1.0/accounts");
		...
		public Page<B2bAssignableUser> getAssignableB2BUsersPage()
			...
			HttpInvoker.HttpResponse httpResponse =
				getAssignableB2BUsersPageHttpResponse();
			...
			try {
				return Page.of(content, B2bAssignableUserSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getAssignableB2BUsersPageHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/fin-services-rest/v1.0/assignable-b2b-users");
