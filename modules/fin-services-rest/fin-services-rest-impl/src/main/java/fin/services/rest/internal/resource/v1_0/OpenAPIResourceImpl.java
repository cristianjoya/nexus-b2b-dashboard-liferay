...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "FinServicesRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "FinServicesRest", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(CreditApplicationResourceImpl.class);

			add(TransactionResourceImpl.class);
