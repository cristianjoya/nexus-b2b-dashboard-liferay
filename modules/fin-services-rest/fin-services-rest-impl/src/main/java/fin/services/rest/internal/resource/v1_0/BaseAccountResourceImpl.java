...
public abstract class BaseAccountResourceImpl
	 ...
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/{accountId}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/{accountId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public Page<Account> getAccountsPage(
			...
			String search,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("accountType")
			String accountType,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/fin-services-rest/v1.0/assignable-b2b-users'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/assignable-b2b-users")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts' -d $'{"accountId": ___, "accountName": ___, "accountNumber": ___, "accountType": ___, "balance": ___, "cardBankName": ___, "cardBrand": ___, "cardCountryName": ___, "cardScheme": ___, "createDate": ___, "modifiedDate": ___, "ownerUserId": ___, "ownerUserName": ___, "status": ___, "uuid": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Account")}
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/{accountId}' -d $'{"accountId": ___, "accountName": ___, "accountNumber": ___, "accountType": ___, "balance": ___, "cardBankName": ___, "cardBrand": ___, "cardCountryName": ___, "cardScheme": ___, "createDate": ___, "modifiedDate": ___, "ownerUserId": ___, "ownerUserName": ___, "status": ___, "uuid": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/fin-services-rest/v1.0/accounts/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	public Page<Account> read(
		...
		return getAccountsPage(
			search, (String)parameters.get("accountType"),
			_parseInteger((String)parameters.get("status")),
			_parseLong((String)parameters.get("ownerUserId")), pagination);
	}
