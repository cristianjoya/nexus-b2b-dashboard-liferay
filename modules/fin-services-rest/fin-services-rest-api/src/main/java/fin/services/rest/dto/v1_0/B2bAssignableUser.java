...
@Generated("")
@GraphQLName(
	description = "B2B User that can own an account on the site",
	value = "B2bAssignableUser"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "B2bAssignableUser")
public class B2bAssignableUser implements Serializable {

	public static B2bAssignableUser toDTO(String json) {
		return ObjectMapperUtil.readValue(B2bAssignableUser.class, json);
	}

	public static B2bAssignableUser unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(B2bAssignableUser.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "fin.services.rest.dto.v1_0.B2bAssignableUser",
		name = "x-class-name"
	)
