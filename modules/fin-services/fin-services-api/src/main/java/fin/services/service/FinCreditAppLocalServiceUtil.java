...
/**
 * Provides the local service utility for FinCreditApp. This utility wraps
 * <code>fin.services.service.impl.FinCreditAppLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FinCreditAppLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>fin.services.service.impl.FinCreditAppLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FinCreditApp addFinCreditApp(FinCreditApp finCreditApp) {
		return getService().addFinCreditApp(finCreditApp);
	}

	public static int countSearchFinCreditAppsByGroupId(
		long groupId, String keywords, Long accountId, Integer status,
		java.util.Collection<Long> restrictedAccountIds) {

		return getService().countSearchFinCreditAppsByGroupId(
	 ...
	 */
	public static FinCreditApp createFinCreditApp(long creditAppId) {
		return getService().createFinCreditApp(creditAppId);
	}
	 ...
	 */
	public static FinCreditApp deleteFinCreditApp(FinCreditApp finCreditApp) {
		return getService().deleteFinCreditApp(finCreditApp);
	}
	 ...
	 */
	public static FinCreditApp deleteFinCreditApp(long creditAppId)
		throws PortalException {

		return getService().deleteFinCreditApp(creditAppId);
	}
	...
	public static FinCreditApp fetchFinCreditApp(long creditAppId) {
		return getService().fetchFinCreditApp(creditAppId);
	}
	 ...
	 */
	public static FinCreditApp fetchFinCreditAppByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchFinCreditAppByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a fin credit app with the primary key could not be found
	 */
	public static FinCreditApp getFinCreditApp(long creditAppId)
		throws PortalException {

		return getService().getFinCreditApp(creditAppId);
	}
	 ...
	 */
	public static FinCreditApp getFinCreditAppByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getFinCreditAppByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<FinCreditApp> getFinCreditApps(int start, int end) {
		return getService().getFinCreditApps(start, end);
	}
	 ...
	 */
	public static List<FinCreditApp> getFinCreditAppsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getFinCreditAppsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<FinCreditApp> getFinCreditAppsByUuidAndCompanyId(
		...
		return getService().getFinCreditAppsByUuidAndCompanyId(
	 ...
	 */
	public static int getFinCreditAppsCount() {
		return getService().getFinCreditAppsCount();
	}
	...
	public static List<FinCreditApp> searchFinCreditAppsByGroupId(
		long groupId, String keywords, Long accountId, Integer status,
		java.util.Collection<Long> restrictedAccountIds, int start, int end) {

		return getService().searchFinCreditAppsByGroupId(
	 ...
	 */
	public static FinCreditApp updateFinCreditApp(FinCreditApp finCreditApp) {
		return getService().updateFinCreditApp(finCreditApp);
	}

	public static FinCreditAppLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FinCreditAppLocalService> _serviceSnapshot =
		new Snapshot<>(
			FinCreditAppLocalServiceUtil.class, FinCreditAppLocalService.class);
